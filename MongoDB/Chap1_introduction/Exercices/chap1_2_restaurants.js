...
// 9. Nouvelle question : Trouvez tous les restaurants qui ont dans leur nom le mot clé coffee, qui sont dans le bronx ou dans Brooklyn, qui ont 
// eu exactement 4 appréciations (grades), qui ont eu au moins un A en dernière notation et qui ont été évalués à une date supérieur ou égale à 
// 2012-10-24 mais pas avant. 
...
{ "_id" : 0, "name" : 1, "grades.date" : 1, borough : 1}
    ...
    doc => {
        ...
        print()
        print(`name : ${name.toUpperCase()} Numbers grades : ${count}`)
        print(`
Last grade date : ${GradesValues[0].date} \n
First grade date : ${GradesValues[GradesValues.length - 1].date}
`)
    }
)
...
const coordinate = [ -73.93414657, 40.82302903 ];
